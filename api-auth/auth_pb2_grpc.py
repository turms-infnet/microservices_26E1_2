...
class GrpcAuthServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.verify_token = channel.unary_unary(
                '/auth.GrpcAuthService/verify_token',
...
def add_GrpcAuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'auth.GrpcAuthService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('auth.GrpcAuthService', rpc_method_handlers)
